...
public final class PopupVideoPlayer extends Service {
    ...
    public static final String ACTION_CLOSE = "com.example.discoverfreedom.player.PopupVideoPlayer.CLOSE";
    public static final String ACTION_PLAY_PAUSE = "com.example.discoverfreedom.player.PopupVideoPlayer.PLAY_PAUSE";
    public static final String ACTION_REPEAT = "com.example.discoverfreedom.player.PopupVideoPlayer.REPEAT";
